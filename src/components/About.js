  ...
  <div className="container">
    <div className="row g-5">
      <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeIn"}}>
        <div className="d-flex flex-column"><img className="img-fluid rounded w-75 align-self-end" src="../Image/photo11.jpg" alt="website template image"/> <img className="img-fluid rounded w-70 bg-white pt-3 pe-3" src="../Image/image_3.jpg" alt="website template image" style={{marginTop:"-8%"}}/></div>
      </div>
