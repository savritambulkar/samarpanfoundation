  ...
  <div className="container">
    ...
    <div className="row g-4">
      ...
      <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style={{visibility: "visible", animationDelay: "0.3s", animationName: "fadeInUp"}}>
        <div className="service-item bg-light rounded h-100 p-5">
          <div className="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style={{width:"65px",height:"65px"}}><i className="fa fa-x-ray text-primary fs-4"></i></div>
    ...
    <div class="row g-0 mx-lg-0">
      <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeIn"}}>
        <div class="p-lg-5 ps-lg-0">
          ...
          <h1 class="text-white mb-4">Why Choose Samarpan</h1>
            ...
            <div class="col-6">
              <div class="d-flex align-items-center">
                ...
                <div class="ms-4">
                  ...
                  <h5 class="text-white mb-0">Help</h5>
                </div>
              </div>
            </div>
            <div class="col-6">
