...
<div className="container-fluid bg-light p-0 wow fadeIn" data-wow-delay="0.1s" style={{visibility: "visible", animationDelay: "0.1s", animationName: "fadeIn"}}>
  <div className="row gx-0 d-none d-lg-flex">
    <div className="col-lg-7 px-5 text-start">
      ...
      {/* <div className="h-100 d-inline-flex align-items-center py-3"><small className="far fa-clock text-primary me-2">infosamarpan2025@gmail.com</small></div> */}
    </div>
    <div className="col-lg-5 px-5 text-end">
      <div className="h-100 d-inline-flex align-items-center py-3 me-4"><small className="fa fa-phone-alt text-primary me-2"></small> <small>+91 9171188434</small></div>
  ...
  <div className="collapse navbar-collapse" id="navbarCollapse">
    <div className="navbar-nav ms-auto p-4 p-lg-0"><Link to="/" className="nav-item nav-link active">Home</Link> <Link to="/About" className="nav-item nav-link">About</Link> <Link to="/Service" className="nav-item nav-link">Service</Link>
      <div className="nav-item dropdown"><Link to="/Service" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Get Involve</Link>
        <div className="dropdown-menu rounded-0 rounded-bottom m-0"><Link  className="dropdown-item" to={"/vol/register"}>Volunteer Ragistration</Link> <Link  className="dropdown-item" to={"/ngo/register"}>NGO Ragistration</Link> <Link  className="dropdown-item" to={"/com/register"}>Company Ragistration</Link> </div>
      </div>
